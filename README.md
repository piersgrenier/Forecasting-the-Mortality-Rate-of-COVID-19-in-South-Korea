...
Expected output:
- both AR and ARMA models have high forecast accuracy for younger ages and patients living in less population dense provinces
- both AR and ARMA models have lower forecast accuracy for older patients and patients living in population dense provinces
